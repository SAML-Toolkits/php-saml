...
class OneLogin_Saml2_ResponseTest extends PHPUnit_Framework_TestCase
{
    ...
    */
    public function testConstruct()
    {
        ...
        $response = new OneLogin_Saml2_Response($this->_settings, $xml, $this->logger);
        ...
        $responseEnc = new OneLogin_Saml2_Response($this->_settings, $xmlEnc, $this->logger);
    ...
    public function testGetXMLDocument()
    {
        ...
        $response = new OneLogin_Saml2_Response($this->_settings, $encodedResponse, $this->logger);
        ...
        $response2 = new OneLogin_Saml2_Response($this->_settings, $encodedResponse2, $this->logger);
    ...
    */
    public function testReturnNameId()
    {
        ...
        $response2 = new OneLogin_Saml2_Response($this->_settings, $xml2, $this->logger);
        ...
        $response3 = new OneLogin_Saml2_Response($this->_settings, $xml3, $this->logger);
        ...
        $response4 = new OneLogin_Saml2_Response($this->_settings, $xml4, $this->logger);
        ...
        $settings = new OneLogin_Saml2_Settings($settingsInfo);
        $response5 = new OneLogin_Saml2_Response($settings, $xml4, $this->logger);
        ...
        $settings = new OneLogin_Saml2_Settings($settingsInfo);
        $response6 = new OneLogin_Saml2_Response($settings, $xml4, $this->logger);
        $nameId6 = $response6->getNameId();
        $this->assertNull($nameId6);

        unset($settingsInfo['security']['wantNameId']);
        $settings = new OneLogin_Saml2_Settings($settingsInfo);
        $response7 = new OneLogin_Saml2_Response($settings, $xml4, $this->logger);
        ...
        $response8 = new OneLogin_Saml2_Response($settings, $xml5, $this->logger);
        ...
        $response9 = new OneLogin_Saml2_Response($settings, $xml6, $this->logger);
        $nameId9 = $response9->getNameId();
        $this->assertEmpty($nameId9);

        $settingsInfo['strict'] = true;
        $settings = new OneLogin_Saml2_Settings($settingsInfo);
        $response10 = new OneLogin_Saml2_Response($settings, $xml5, $this->logger);
        try {
        ...
        $response11 = new OneLogin_Saml2_Response($settings, $xml6, $this->logger);
    ...
    */
    public function testQueryAssertions()
    {
        ...
        $response5 = new OneLogin_Saml2_Response($this->_settings, $xml5, $this->logger);
        ...
        $response6 = new OneLogin_Saml2_Response($this->_settings, $xml6, $this->logger);
        ...
        $response7 = new OneLogin_Saml2_Response($this->_settings, $xml7, $this->logger);
    ...
    */
    ...
    public function testDoesNotAllowSignatureWrappingAttack2()
    {
        ...
        $response = new OneLogin_Saml2_Response($settings, $xml, $this->logger);
    ...
    */
    public function testValidateNumAssertions()
    {
        ...
        $response2 = new OneLogin_Saml2_Response($this->_settings, $xmlMultiAssertion, $this->logger);
    ...
    */
    public function testIsInValidExpired()
    {
        ...
        $response2 = new OneLogin_Saml2_Response($this->_settings, $xml, $this->logger);
    ...
    */
    public function testIsInValidWrongXML()
    {
        ...
        $response2 = new OneLogin_Saml2_Response($settings, $xml, $this->logger);
        $response2->isValid();
        ...
        $response3 = new OneLogin_Saml2_Response($settings2, $xml, $this->logger);
        $this->assertTrue($response3->isValid());

        $settings2->setStrict(true);
        $response4 = new OneLogin_Saml2_Response($settings2, $xml, $this->logger);
    ...
    */
    public function testIsInValidDestination()
    {
        ...
        $response3 = new OneLogin_Saml2_Response($this->_settings, $xml2, $this->logger);
        ...
        $settings = new OneLogin_Saml2_Settings($settingsInfo);
        $response4 = new OneLogin_Saml2_Response($settings, $xml2, $this->logger);
    ...
    */
    public function testIsInValidAudience()
    {
        ...
        $response = new OneLogin_Saml2_Response($this->_settings, $message, $this->logger);
        $response->isValid();
        $this->assertEquals('No Signature found. SAML Response rejected', $response->getError());

        $this->_settings->setStrict(true);
        $response2 = new OneLogin_Saml2_Response($this->_settings, $message, $this->logger);
    ...
    */
    public function testIsInValidIssuer()
    {
        ...
        $response2 = new OneLogin_Saml2_Response($this->_settings, $message2, $this->logger);
        $response2->isValid();
        $this->assertEquals('No Signature found. SAML Response rejected', $response2->getError());

        $this->_settings->setStrict(true);
        $response3 = new OneLogin_Saml2_Response($this->_settings, $message, $this->logger);
        ...
        $response4 = new OneLogin_Saml2_Response($this->_settings, $message2, $this->logger);
    ...
    */
    public function testIsInValidSubjectConfirmation()
    {
        ...
        $response3 = new OneLogin_Saml2_Response($this->_settings, $message3, $this->logger);
        $response3->isValid();
        $this->assertEquals('No Signature found. SAML Response rejected', $response3->getError());

        $response4 = new OneLogin_Saml2_Response($this->_settings, $message4, $this->logger);
        $response3->isValid();
        $this->assertEquals('No Signature found. SAML Response rejected', $response3->getError());

        $response5 = new OneLogin_Saml2_Response($this->_settings, $message5, $this->logger);
        $response5->isValid();
        $this->assertEquals('No Signature found. SAML Response rejected', $response3->getError());

        $response6 = new OneLogin_Saml2_Response($this->_settings, $message6, $this->logger);
        $response6->isValid();
        $this->assertEquals('No Signature found. SAML Response rejected', $response3->getError());
...
/**
    ...
    */
    public function testIsInValidSignIssues()
    {
        ...
        $settings = new OneLogin_Saml2_Settings($settingsInfo);
        $response = new OneLogin_Saml2_Response($settings, $message, $this->logger);
        $response->isValid();
        ...
        $settings2 = new OneLogin_Saml2_Settings($settingsInfo);
        $response2 = new OneLogin_Saml2_Response($settings2, $message, $this->logger);
        $response2->isValid();
        $this->assertContains('No Signature found. SAML Response rejected', $response2->getError());
        ...
        $response3 = new OneLogin_Saml2_Response($settings3, $message, $this->logger);
        $response3->isValid();
        ...
        $response4 = new OneLogin_Saml2_Response($settings4, $message, $this->logger);
        ...
        $response5 = new OneLogin_Saml2_Response($settings5, $message, $this->logger);
        $response5->isValid();
        ...
        $response6 = new OneLogin_Saml2_Response($settings6, $message, $this->logger);
        $response6->isValid();
        ...
        $response7 = new OneLogin_Saml2_Response($settings7, $message, $this->logger);
        $response7->isValid();
        ...
        $response8 = new OneLogin_Saml2_Response($settings8, $message, $this->logger);
    ...
    */
    public function testIsInValidEncIssues()
    {
        ...
        $settings = new OneLogin_Saml2_Settings($settingsInfo);
        $response2 = new OneLogin_Saml2_Response($settings, $message, $this->logger);
        $response2->isValid();
        $this->assertContains('No Signature found. SAML Response rejected', $response2->getError());

        $settingsInfo['security']['wantAssertionsEncrypted'] = true;
        $settings = new OneLogin_Saml2_Settings($settingsInfo);
        $response3 = new OneLogin_Saml2_Response($settings, $message, $this->logger);
        ...
        $settingsInfo['strict'] = false;
        $settings = new OneLogin_Saml2_Settings($settingsInfo);
        $response4 = new OneLogin_Saml2_Response($settings, $message, $this->logger);
        $response4->isValid();
        $this->assertContains('No Signature found. SAML Response rejected', $response4->getError());

        $settingsInfo['strict'] = true;
        $settings = new OneLogin_Saml2_Settings($settingsInfo);
        $response5 = new OneLogin_Saml2_Response($settings, $message, $this->logger);
        $this->assertFalse($response5->isValid());
    ...
    */
    public function testIsValidEnc()
    {
        ...
        $response4 = new OneLogin_Saml2_Response($settings, $message4, $this->logger);
